...
class UuidV7Test {
    ...
    fun `lexicographic sort matches chronological sort across millisecond boundary`() {
        val earlier = UuidV7(Clock.fixed(Instant.parse("2026-01-01T00:00:00Z"), ZoneOffset.UTC)).nextString()
        val later = UuidV7(Clock.fixed(Instant.parse("2026-01-01T00:00:01Z"), ZoneOffset.UTC)).nextString()
